/**
 * Generali - A WhatsApp Bot
 * Copyright (c) 2025 Generali 
 * 
...
let phoneNumber = "254721932901"
let owner = JSON.parse(fs.readFileSync('./database/owner.json'))

global.botname = "Generali"
global.themeemoji = "•"
...
async function startXeonBotInc() {
    ...
    XeonBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || 'Generali} ]`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} `))
            console.log(chalk.magenta(`${global.themeemoji || '•'} `))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: Generali `))
